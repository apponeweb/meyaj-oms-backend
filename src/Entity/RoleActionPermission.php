...
#[ORM\Table(name: 'role_action_permission')]
#[ORM\UniqueConstraint(name: 'unique_role_module_action', columns: ['role_id', 'app_module_id', 'action_id'])]
class RoleActionPermission
{
    ...
    public function getAction(): ActionCatalog
    {
        return $this->action;
    }

    public function setAction(ActionCatalog $action): static
    {
        $this->action = $action;
        return $this;
    }
