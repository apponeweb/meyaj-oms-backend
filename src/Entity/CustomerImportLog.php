...
use App\Repository\CustomerImportLogRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: CustomerImportLogRepository::class)]
#[ORM\Table(name: 'customer_import_log')]
class CustomerImportLog
{
