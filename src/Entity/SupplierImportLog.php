...
use App\Repository\SupplierImportLogRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: SupplierImportLogRepository::class)]
#[ORM\Table(name: 'supplier_import_log')]
class SupplierImportLog
{
